...
@section('content')
    ...
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="Grofresh Software Installation"
             ...
             data-bs-placement="top" data-bs-custom-class="custom-progress-tooltip" data-bs-title="{{\App\CPU\translate('Second Step')}}!"
    ...
    <div class="card mt-4">
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            ...
            <div class="d-flex align-items-center column-gap-3 flex-wrap">
                ...
                <h5 class="fw-normal">{{\App\CPU\translate('Update Purchase Information')}} | <a style="color:red;" href="https://weadown.com" target="_blank">weadown.com</a></h5>
            </div>
            <p class="mb-4">{{\App\CPU\translate('Provide your')}} <strong>{{\App\CPU\translate('username')}} </strong>{{\App\CPU\translate('of codecanyon & the')}} <strong>{{\App\CPU\translate('purchase code')}}</strong></p>
            ...
            <form method="POST" action="{{ route('purchase.code',['token'=>bcrypt('step_3')]) }}">
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    <label for="username" class="d-flex align-items-center gap-2 mb-2">
                                        <span class="fw-medium">{{\App\CPU\translate('Username')}}</span>
                                        <span class="cursor-pointer" data-bs-toggle="tooltip"
                                              data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                                              data-bs-html="true"
                                              data-bs-title="{{\App\CPU\translate('The username of your codecanyon account')}}">
                                                    <img
                                    ...
                                    <input type="text" id="username" class="form-control" name="username"
                                           placeholder="{{\App\CPU\translate('Ex: John Doe')}}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="from-group">
                                    <label for="purchase_key" class="mb-2">
                                        ...
                                        <span class="cursor-pointer" data-bs-toggle="tooltip"
                                              data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                                              data-bs-html="true"
                                              data-bs-title="{{\App\CPU\translate('The purchase code')}}">
                                                    <img
                                                        src="{{asset('public/assets/installation')}}/assets/img/svg-icons/info2.svg"
                                                        class="svg" alt="">
                                        </span>
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-dark px-sm-5">{{\App\CPU\translate('Continue')}}</button>
                </div>
            </form>
        </div>
    </div>
